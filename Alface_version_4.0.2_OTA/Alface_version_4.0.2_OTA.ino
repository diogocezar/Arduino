/**
 * Projeto versao 4.0.2_OTA compilada em 31 de dezembro de 2018 as 22:43
...
#define TAMANHO_STRING_SERIAL      ((4*5) + 4 + 1)  //5 canais (de 4 bytes de informação cada, em ASCII) e 4 separadores (;) e 1 terminador de string (\0)
/**
 ...
 */
 ...
 // ArduinoOTA.setPort(5600);
  ...
  ArduinoOTA.setHostname("Projeto-Alface versão 4.0.2");
...
void checarUmidade()
{
  leituraUmidade =StringLeiturasADC[0] ;
